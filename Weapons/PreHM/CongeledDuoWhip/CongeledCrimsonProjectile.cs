...
{
	public class CongeledCrimsonProjectile : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Timer >= swingTime / 2) { 
				List<Vector2> points = Projectile.WhipPointsForCollision;
				Dust.NewDust(points[points.Count - 1], Projectile.width, Projectile.height, DustID.CrimsonTorch, Projectile.velocity.X, Projectile.velocity.Y, 25, default(Color), .7f);
			}
		}
	}
}

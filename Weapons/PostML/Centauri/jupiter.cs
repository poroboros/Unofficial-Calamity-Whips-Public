    ...
    internal class jupiter : ModProjectile{
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 8; i++) {
				...
				Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity, ModContent.ProjectileType<Mercury>(), Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
			}
		}
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			SoundEngine.PlaySound(Main.rand.NextBool() ? SoundID.Item42 : SoundID.Item42, Projectile.position);

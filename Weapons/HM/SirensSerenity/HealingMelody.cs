...
{
	public class HealingMelody : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			player.GetModPlayer<HealingMelodyPlayer>().healingMelody = true;
		}
...
public class HealingMelodyPlayer: ModPlayer 
{
	public bool healingMelody = false;
